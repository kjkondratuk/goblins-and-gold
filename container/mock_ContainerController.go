...
func (_m *MockContainerController) Do(s state.State, c state.Container, t interaction.Type) (interaction.Result, error) {
	ret := _m.Called(s, c, t)
...
func (_c *MockContainerController_Do_Call) Run(run func(s state.State, c state.Container, t interaction.Type)) *MockContainerController_Do_Call {
...
func (_c *MockContainerController_Do_Call) RunAndReturn(run func(state.State, state.Container, interaction.Type) (interaction.Result, error)) *MockContainerController_Do_Call {
	_c.Call.Return(run)
	return _c
}
